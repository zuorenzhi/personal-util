...
public class JedisLock {
    ...
    private boolean setNX(final String key, final String value) {
        ...
        Jedis jedis = getJedis();
        StringRedisSerializer serializer = new StringRedisSerializer();
        Long setnx = jedis.setnx(serializer.serialize(key), serializer.serialize(value));
        return setnx == 1;
    }
    ...
    private String getSet(final String key, final String value) {
        Jedis jedis = getJedis();
        StringRedisSerializer serializer = new StringRedisSerializer();
        byte[] ret = jedis.getSet(serializer.serialize(key), serializer.serialize(value));
    ...
    public synchronized void unlockII() {
        String strTime = get(lockKey);
        if (strTime == null || strTime == "") {
            return;
        }
        long longValue = Long.parseLong(strTime);
