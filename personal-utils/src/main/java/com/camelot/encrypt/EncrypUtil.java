...
import com.camelot.bean.ExecuteResult;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class EncrypUtil {
	private static final Logger LOGGER=LoggerFactory
			.getLogger(EncrypUtil.class);
	/**
	 * 通过AES加密
	 * @param key 秘钥
	...
	public static void main(String[] args){
		String key = "zhangzhiqiang";
		ExecuteResult<String> con = EncrypUtil.EncrypStrByAES(key, "123456");
		LOGGER.info("加密后:" + con.getResult());
		LOGGER.info("解密后:" + EncrypUtil.DecryptStrByAES(key, con.getResult()).getResult());
	}
